...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '获奖记录表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `biz_award_record` VALUES (5, 4, 2, 2, 2, 13, '2026-03-13', '2025-2026-1', '来看看看', 1, 1, 'APPROVED', 5, '2026-03-25 20:29:48', '2026-03-26 20:00:28', NULL, 4, 0, '2026-03-25 20:10:35', '2026-03-26 20:00:28');
INSERT INTO `biz_award_record` VALUES (6, 5, 2, 2, 2, 17, '2026-03-28', 'sfsdfsdfsfd', 'sdadsdad', 1, 1, 'DRAFT', 5, NULL, NULL, NULL, 0, 0, '2026-03-26 20:10:13', '2026-03-26 20:10:13');
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '审核轨迹表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `biz_award_record_audit` VALUES (11, 5, 'SCHOOL', 'SUBMIT', 'DRAFT', 'PENDING_SCHOOL', NULL, 5, NULL, '2026-03-25 20:29:48');
INSERT INTO `biz_award_record_audit` VALUES (12, 5, 'SCHOOL', 'APPROVE', 'PENDING_SCHOOL', 'APPROVED', NULL, 1, NULL, '2026-03-26 20:00:28');
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '获奖附件关联表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `biz_award_record_file` VALUES (5, 5, 5, 0, '2026-03-25 20:29:54');
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '团队表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `biz_team` VALUES (4, '测试团队', 5, 1, 'ACTIVE', '', 0, '2026-03-25 19:39:41', '2026-03-25 19:39:41');
INSERT INTO `biz_team` VALUES (5, 'dassada', 5, 1, 'ACTIVE', '', 0, '2026-03-26 20:01:02', '2026-03-26 20:01:02');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '团队邀请表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `biz_team_invitation` VALUES (2, 4, 6, 'MEMBER', 'ACCEPTED', 5, '2026-03-25 19:49:29', '2026-03-25 19:53:59');
INSERT INTO `biz_team_invitation` VALUES (3, 5, 8, 'MEMBER', 'PENDING', 5, '2026-03-26 20:01:37', '2026-03-26 20:01:37');
INSERT INTO `biz_team_invitation` VALUES (4, 5, 13, 'TEACHER', 'ACCEPTED', 5, '2026-03-26 20:01:52', '2026-03-26 20:02:23');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '团队成员表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `biz_team_member` VALUES (4, 4, 5, 1, 1, 'ACCEPTED');
INSERT INTO `biz_team_member` VALUES (5, 4, 6, 1, 0, 'ACCEPTED');
INSERT INTO `biz_team_member` VALUES (6, 5, 5, 1, 1, 'ACCEPTED');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '团队指导教师表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of biz_team_teacher
-- ----------------------------
INSERT INTO `biz_team_teacher` VALUES (1, 5, 13, 1, 'ACCEPTED');
...
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '奖项等级字典（按竞赛+范围配置）' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of dict_award_level
-- ----------------------------
INSERT INTO `dict_award_level` VALUES (16, NULL, 3, '一等奖', 1, 0);
INSERT INTO `dict_award_level` VALUES (17, NULL, 2, '一等奖', 1, 0);
INSERT INTO `dict_award_level` VALUES (18, NULL, 2, 'ssss', 1, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '班级字典（按院系归属）' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of dict_class
-- ----------------------------
INSERT INTO `dict_class` VALUES (1, 1, '计算机科学与技术2023级1班', 0, 1);
INSERT INTO `dict_class` VALUES (2, 1, '计算机科学与技术2023级2班', 1, 2);
INSERT INTO `dict_class` VALUES (3, 1, '软件工程2023级1班', 1, 3);
...
-- ----------------------------
INSERT INTO `dict_competition` VALUES (1, '全国大学生智能汽车竞赛', '智能车竞赛', 1, 1, 3, '教育部认可的A类竞赛');
...
INSERT INTO `dict_competition` VALUES (4, '全国大学生数学建模竞赛', '数学建模', 2, 1, 3, '教育部认可的A类竞赛');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '竞赛类别字典' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `dict_competition_category` VALUES (4, '测试类', NULL, 1, 1, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '竞赛-主办方关联表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of dict_competition_organizer
-- ----------------------------
INSERT INTO `dict_competition_organizer` VALUES (16, 2, 7, 1, 0);
INSERT INTO `dict_competition_organizer` VALUES (17, 1, 1, 1, 0);
INSERT INTO `dict_competition_organizer` VALUES (18, 4, 1, 1, 0);
INSERT INTO `dict_competition_organizer` VALUES (19, 3, 5, 1, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文件元数据（M2临时表，后续可合并到业务附件表）' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_file` VALUES (5, '4C2026大赛通知（发布版）.pdf', 'pdf', 'application/pdf', '.\\data\\files\\2026-03-25\\fa1d689f-cd1d-4a75-b15f-957a1b3b2579.pdf', 'pdf', 1185751, 5, '2026-03-25 20:29:54', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '站内消息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_message
-- ----------------------------
INSERT INTO `sys_message` VALUES (1, 3, 'AUDIT', '审核通过', '你提交的获奖填报（ID=4，项目：123）已审核通过。', 'AWARD_RECORD', 4, 0, '2026-03-22 22:36:43');
INSERT INTO `sys_message` VALUES (2, 6, 'INVITATION', '团队邀请', '李四 邀请你加入团队「测试团队」（成员）。', 'TEAM_INVITATION', 2, 1, '2026-03-25 19:49:29');
INSERT INTO `sys_message` VALUES (3, 5, 'INVITATION', '邀请已接受', '王五 已接受你对团队「测试团队」的邀请（MEMBER）。', 'TEAM_INVITATION', 2, 1, '2026-03-25 19:53:59');
INSERT INTO `sys_message` VALUES (4, 5, 'AUDIT', '审核通过', '你提交的获奖填报（ID=5，项目：来看看看）已审核通过。', 'AWARD_RECORD', 5, 1, '2026-03-26 20:00:28');
INSERT INTO `sys_message` VALUES (5, 8, 'INVITATION', '团队邀请', '李四 邀请你加入团队「dassada」（成员）。', 'TEAM_INVITATION', 3, 0, '2026-03-26 20:01:37');
INSERT INTO `sys_message` VALUES (6, 13, 'INVITATION', '团队邀请', '李四 邀请你加入团队「dassada」（指导教师）。', 'TEAM_INVITATION', 4, 1, '2026-03-26 20:01:52');
INSERT INTO `sys_message` VALUES (7, 5, 'INVITATION', '邀请已接受', '王老师 已接受你对团队「dassada」的邀请（TEACHER）。', 'TEAM_INVITATION', 4, 1, '2026-03-26 20:02:23');
...
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '本地用户表（后续可被外部同步覆盖基础字段）' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_user` VALUES (3, 'student1', '$2a$10$0gPgoZXD6GwMjIdtkd6SxOd9Abbv6e8REtHuyttVk6wPHunyS.GWG', '张三', 'STUDENT', 1, 1, '2026-03-17 22:22:11', '2026-03-25 19:29:37', NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (4, 'teacher1', '$2a$10$0gPgoZXD6GwMjIdtkd6SxOd9Abbv6e8REtHuyttVk6wPHunyS.GWG', '李老师', 'TEACHER', 1, 1, '2026-03-17 22:22:11', '2026-03-25 19:29:37', NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (5, 'student2', '$2a$10$0gPgoZXD6GwMjIdtkd6SxOd9Abbv6e8REtHuyttVk6wPHunyS.GWG', '李四', 'STUDENT', 1, 1, '2026-03-25 18:49:01', '2026-03-25 19:29:37', '2023002', NULL, 1);
INSERT INTO `sys_user` VALUES (6, 'student3', '$2a$10$0gPgoZXD6GwMjIdtkd6SxOd9Abbv6e8REtHuyttVk6wPHunyS.GWG', '王五', 'STUDENT', 1, 1, '2026-03-25 18:49:01', '2026-03-25 19:29:37', '2023003', NULL, 1);
INSERT INTO `sys_user` VALUES (7, 'student4', '$2a$10$0gPgoZXD6GwMjIdtkd6SxOd9Abbv6e8REtHuyttVk6wPHunyS.GWG', '赵六', 'STUDENT', 1, 1, '2026-03-25 18:49:01', '2026-03-25 19:29:37', '2023004', NULL, 2);
INSERT INTO `sys_user` VALUES (8, 'student5', '$2a$10$0gPgoZXD6GwMjIdtkd6SxOd9Abbv6e8REtHuyttVk6wPHunyS.GWG', '钱七', 'STUDENT', 1, 1, '2026-03-25 18:49:01', '2026-03-25 19:29:37', '2023005', NULL, 2);
INSERT INTO `sys_user` VALUES (9, 'student6', '$2a$10$0gPgoZXD6GwMjIdtkd6SxOd9Abbv6e8REtHuyttVk6wPHunyS.GWG', '孙八', 'STUDENT', 1, 1, '2026-03-25 18:49:01', '2026-03-25 19:29:37', '2023006', NULL, 3);
INSERT INTO `sys_user` VALUES (10, 'student7', '$2a$10$0gPgoZXD6GwMjIdtkd6SxOd9Abbv6e8REtHuyttVk6wPHunyS.GWG', '周九', 'STUDENT', 1, 1, '2026-03-25 18:49:01', '2026-03-25 19:29:37', '2023007', NULL, 3);
INSERT INTO `sys_user` VALUES (11, 'student8', '$2a$10$0gPgoZXD6GwMjIdtkd6SxOd9Abbv6e8REtHuyttVk6wPHunyS.GWG', '吴十', 'STUDENT', 1, 1, '2026-03-25 18:49:01', '2026-03-25 19:29:37', '2023008', NULL, 3);
INSERT INTO `sys_user` VALUES (13, 'teacher2', '$2a$10$0gPgoZXD6GwMjIdtkd6SxOd9Abbv6e8REtHuyttVk6wPHunyS.GWG', '王老师', 'TEACHER', 1, 1, '2026-03-25 18:49:01', '2026-03-25 19:29:37', NULL, 'T2023002', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户-角色关联' ROW_FORMAT = DYNAMIC;
