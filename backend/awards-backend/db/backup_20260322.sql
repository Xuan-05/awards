...
CREATE TABLE `biz_award_record`  (
  ...
  `organizer_id` bigint NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `biz_award_record` VALUES (1, 2, 1, 1, 1, 1, 1, '2026-03-18', '2025-2026-2', '111', 1, 1, 'APPROVED', 3, '2026-03-18 16:29:59', '2026-03-18 16:59:44', NULL, 3, 0, '2026-03-18 16:29:04', '2026-03-18 16:59:43');
INSERT INTO `biz_award_record` VALUES (2, 2, 1, 1, 1, 1, 1, '2026-02-25', '2025-2026-1', '222', 1, 1, 'APPROVED', 3, '2026-03-18 17:16:55', '2026-03-18 17:17:07', NULL, 5, 0, '2026-03-18 17:15:38', '2026-03-18 17:17:07');
INSERT INTO `biz_award_record` VALUES (3, 2, 1, 1, 1, 1, 1, '2026-02-25', '2025-2026-2', '333', 1, 1, 'SCHOOL_REJECTED', 3, '2026-03-18 20:45:34', NULL, NULL, 3, 0, '2026-03-18 20:45:16', '2026-03-18 20:45:48');
INSERT INTO `biz_award_record` VALUES (4, 2, 4, 2, NULL, 2, 2, '2026-03-18', '2025-2026-2', '123', 1, 1, 'APPROVED', 3, '2026-03-22 22:35:44', '2026-03-22 22:36:43', NULL, 3, 0, '2026-03-22 22:35:15', '2026-03-22 22:36:43');
...
CREATE TABLE `dict_award_level`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `award_scope_id` bigint NOT NULL,
  `award_level_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `award_level_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT 1,
  `sort_no` int NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_scope_level`(`award_scope_id` ASC, `award_level_code` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '奖项等级字典' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dict_award_level
-- ----------------------------
INSERT INTO `dict_award_level` VALUES (1, 1, '通用奖项', '通用奖项', 1, 0);
INSERT INTO `dict_award_level` VALUES (2, 2, '01', '一等奖', 1, 0);
INSERT INTO `dict_award_level` VALUES (7, 2, '02', '二等奖', 1, 0);
INSERT INTO `dict_award_level` VALUES (8, 2, '03', '三等奖', 1, 0);
INSERT INTO `dict_award_level` VALUES (9, 7, '01', '一等奖', 1, 0);
INSERT INTO `dict_award_level` VALUES (10, 7, '02', '二等奖', 1, 0);
INSERT INTO `dict_award_level` VALUES (12, 7, '03', '三等奖', 1, 0);
...
CREATE TABLE `dict_award_scope`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `scope_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `scope_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT 1,
  `sort_no` int NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `scope_code`(`scope_code` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '奖项范围，如国家级/省部级' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dict_award_scope
-- ----------------------------
INSERT INTO `dict_award_scope` VALUES (1, 'OTHER', '其他', 0, 0);
INSERT INTO `dict_award_scope` VALUES (2, '01', '国家级', 1, 0);
INSERT INTO `dict_award_scope` VALUES (7, '02', '省级', 1, 1);
...
CREATE TABLE `dict_competition`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `competition_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `competition_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `competition_short_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `category_id` bigint NOT NULL,
  `default_level` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `organizer_id` bigint NULL DEFAULT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT 1,
  `sort_no` int NOT NULL DEFAULT 0,
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `competition_code`(`competition_code` ASC) USING BTREE,
...
-- ----------------------------
INSERT INTO `dict_competition` VALUES (1, 'COMP-3c5fedd3bccf', '??????', NULL, 1, NULL, 1, 1, 0, NULL);
INSERT INTO `dict_competition` VALUES (2, 'COMP-5df07f89b508', '????A', NULL, 2, NULL, 2, 1, 0, NULL);
INSERT INTO `dict_competition` VALUES (3, 'COMP-dadc068e753a', '????B', NULL, 3, NULL, 3, 1, 0, NULL);
INSERT INTO `dict_competition` VALUES (4, 'COMP-53afdab8a8a4', '计算机设计大赛', NULL, 2, NULL, NULL, 1, 0, NULL);
...
-- ----------------------------
INSERT INTO `dict_competition_category` VALUES (1, '????', '????类', 1, 0, NULL);
INSERT INTO `dict_competition_category` VALUES (2, 'A', 'A类', 1, 0, NULL);
INSERT INTO `dict_competition_category` VALUES (3, 'B', 'B类', 1, 0, NULL);
...
CREATE TABLE `dict_organizer`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `organizer_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT 1,
  `sort_no` int NOT NULL DEFAULT 0,
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '主办单位字典' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dict_organizer
-- ----------------------------
INSERT INTO `dict_organizer` VALUES (1, '???(??)', 1, 0, NULL);
INSERT INTO `dict_organizer` VALUES (2, '?????????', 1, 0, NULL);
INSERT INTO `dict_organizer` VALUES (3, '????????????', 1, 0, NULL);
